...
(defprotocol FactStore
  ...
  (set-node-weight!      [this eid weight])
  (set-node-blob-dir!    [this eid blob-dir])
  (reinforce-node!       [this eid content score factor])
  (reinforce-weight!     [this eid score factor])
  ...
  (find-or-create-edge!  [this from-eid to-eid w opts])
  (strengthen-edge!      [this edge-id score factor])
